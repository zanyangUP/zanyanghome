<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="header">
      ...
      <a href="javascript:void(0)" class="icon-menu" id="menu"></a>
					...
					$(function(){
						...
						*/
						...
						$.post(url,param,function(data){
							...
							$(data).each(function(i,n){ //i:数组中当前对象的索引   n:数组中当前对象
								$("#navigator").append("<li><a href='${pageContext.request.contextPath}/findInfosByCid.action?cid="+n.cid+"'>"+n.cname+"</a></li>");
							});
						},"json");
					});
				</script>
